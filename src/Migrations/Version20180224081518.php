 ...
 */
class Version20180224081518 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__application AS SELECT id, pets, instruments FROM application');
        $this->addSql('DROP TABLE application');
        $this->addSql('CREATE TABLE application (id INTEGER NOT NULL, application_slot_id INTEGER DEFAULT NULL, pets CLOB DEFAULT NULL COLLATE BINARY, instruments CLOB DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_A45BDDC1B25B14AF FOREIGN KEY (application_slot_id) REFERENCES application_slot (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO application (id, pets, instruments) SELECT id, pets, instruments FROM __temp__application');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__application AS SELECT id, pets, instruments FROM application');
        $this->addSql('DROP TABLE application');
        $this->addSql('CREATE TABLE application (id INTEGER NOT NULL, pets CLOB DEFAULT NULL, instruments CLOB DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO application (id, pets, instruments) SELECT id, pets, instruments FROM __temp__application');
        $this->addSql('DROP TABLE __temp__application');
        $this->addSql('DROP INDEX IDX_5BE248EF176DFE85');
