 ...
 */
class Version20180225035731 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX UNIQ_CAAD10196A5AD134');
        $this->addSql('DROP INDEX IDX_CAAD10193E030ACD');
        $this->addSql('DROP INDEX UNIQ_CAAD1019920427E9');
        $this->addSql('CREATE TEMPORARY TABLE __temp__applicant AS SELECT id, applicant_job_id, application_id, current_landlord_id, salutation, birth_date, civil_status, nationality, street, street_nr, address_line, postal_code, city, country, telephone, email, residence_authorization, telephone_mobile, created_at, last_changed_at, given_name, family_name FROM applicant');
        $this->addSql('DROP TABLE applicant');
        $this->addSql('CREATE TABLE applicant (id INTEGER NOT NULL, applicant_job_id INTEGER DEFAULT NULL, application_id INTEGER DEFAULT NULL, current_landlord_id INTEGER DEFAULT NULL, salutation CLOB DEFAULT NULL COLLATE BINARY, birth_date DATE DEFAULT NULL, civil_status CLOB DEFAULT NULL COLLATE BINARY, nationality CLOB DEFAULT NULL COLLATE BINARY, street CLOB DEFAULT NULL COLLATE BINARY, street_nr CLOB DEFAULT NULL COLLATE BINARY, address_line CLOB DEFAULT NULL COLLATE BINARY, postal_code INTEGER DEFAULT NULL, city CLOB DEFAULT NULL COLLATE BINARY, country CLOB DEFAULT NULL COLLATE BINARY, telephone CLOB DEFAULT NULL COLLATE BINARY, email CLOB NOT NULL COLLATE BINARY, residence_authorization CLOB DEFAULT NULL COLLATE BINARY, telephone_mobile CLOB DEFAULT NULL COLLATE BINARY, created_at DATETIME DEFAULT NULL, last_changed_at DATETIME DEFAULT NULL, given_name CLOB DEFAULT NULL COLLATE BINARY, family_name CLOB DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_CAAD1019920427E9 FOREIGN KEY (applicant_job_id) REFERENCES applicant_job (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CAAD10196A5AD134 FOREIGN KEY (current_landlord_id) REFERENCES applicant_landlord (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_CAAD10193E030ACD FOREIGN KEY (application_id) REFERENCES application (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO applicant (id, applicant_job_id, application_id, current_landlord_id, salutation, birth_date, civil_status, nationality, street, street_nr, address_line, postal_code, city, country, telephone, email, residence_authorization, telephone_mobile, created_at, last_changed_at, given_name, family_name) SELECT id, applicant_job_id, application_id, current_landlord_id, salutation, birth_date, civil_status, nationality, street, street_nr, address_line, postal_code, city, country, telephone, email, residence_authorization, telephone_mobile, created_at, last_changed_at, given_name, family_name FROM __temp__applicant');
        $this->addSql('DROP TABLE __temp__applicant');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_CAAD10196A5AD134 ON applicant (current_landlord_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__applicant_reference AS SELECT id, applicant_id, name, description, telephone, email, telephone_mobile, created_at, last_changed_at, given_name, family_name FROM applicant_reference');
        $this->addSql('DROP TABLE applicant_reference');
        $this->addSql('CREATE TABLE applicant_reference (id INTEGER NOT NULL, applicant_id INTEGER DEFAULT NULL, name CLOB NOT NULL COLLATE BINARY, description CLOB DEFAULT NULL COLLATE BINARY, telephone CLOB DEFAULT NULL COLLATE BINARY, email CLOB NOT NULL COLLATE BINARY, telephone_mobile CLOB DEFAULT NULL COLLATE BINARY, created_at DATETIME DEFAULT NULL, last_changed_at DATETIME DEFAULT NULL, given_name CLOB DEFAULT NULL COLLATE BINARY, family_name CLOB DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_CD6132C597139001 FOREIGN KEY (applicant_id) REFERENCES applicant (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO applicant_reference (id, applicant_id, name, description, telephone, email, telephone_mobile, created_at, last_changed_at, given_name, family_name) SELECT id, applicant_id, name, description, telephone, email, telephone_mobile, created_at, last_changed_at, given_name, family_name FROM __temp__applicant_reference');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__application AS SELECT id, application_slot_id, frontend_user_id, pets, instruments, tenant_count_child, created_at, last_changed_at, status FROM application');
        $this->addSql('DROP TABLE application');
        $this->addSql('CREATE TABLE application (id INTEGER NOT NULL, application_slot_id INTEGER DEFAULT NULL, frontend_user_id INTEGER DEFAULT NULL, pets CLOB DEFAULT NULL COLLATE BINARY, instruments CLOB DEFAULT NULL COLLATE BINARY, tenant_count_child INTEGER DEFAULT NULL, created_at DATETIME DEFAULT NULL, last_changed_at DATETIME DEFAULT NULL, status INTEGER DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_A45BDDC1B25B14AF FOREIGN KEY (application_slot_id) REFERENCES application_slot (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_A45BDDC17887A021 FOREIGN KEY (frontend_user_id) REFERENCES frontend_user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO application (id, application_slot_id, frontend_user_id, pets, instruments, tenant_count_child, created_at, last_changed_at, status) SELECT id, application_slot_id, frontend_user_id, pets, instruments, tenant_count_child, created_at, last_changed_at, status FROM __temp__application');
        ...
        $this->addSql('DROP INDEX IDX_E6BBFD9E3E030ACD');
        $this->addSql('DROP INDEX IDX_E6BBFD9E8C82F02A');
        $this->addSql('CREATE TEMPORARY TABLE __temp__application_application_label AS SELECT application_id, application_label_id FROM application_application_label');
        $this->addSql('DROP TABLE application_application_label');
        $this->addSql('CREATE TABLE application_application_label (application_id INTEGER NOT NULL, application_label_id INTEGER NOT NULL, PRIMARY KEY(application_id, application_label_id), CONSTRAINT FK_E6BBFD9E3E030ACD FOREIGN KEY (application_id) REFERENCES application (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_E6BBFD9E8C82F02A FOREIGN KEY (application_label_id) REFERENCES application_label (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO application_application_label (application_id, application_label_id) SELECT application_id, application_label_id FROM __temp__application_application_label');
        $this->addSql('DROP TABLE __temp__application_application_label');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE import_directory');
        $this->addSql('DROP INDEX IDX_4D7E68544D2A7E12');
        ...
        $this->addSql('DROP INDEX UNIQ_CAAD10196A5AD134');
        $this->addSql('DROP INDEX IDX_CAAD10193E030ACD');
        $this->addSql('CREATE TEMPORARY TABLE __temp__applicant AS SELECT id, applicant_job_id, current_landlord_id, application_id, salutation, birth_date, civil_status, nationality, residence_authorization, created_at, last_changed_at, given_name, family_name, street, street_nr, address_line, postal_code, city, country, telephone, telephone_mobile, email FROM applicant');
        $this->addSql('DROP TABLE applicant');
        $this->addSql('CREATE TABLE applicant (id INTEGER NOT NULL, applicant_job_id INTEGER DEFAULT NULL, current_landlord_id INTEGER DEFAULT NULL, application_id INTEGER DEFAULT NULL, salutation CLOB DEFAULT NULL, birth_date DATE DEFAULT NULL, civil_status CLOB DEFAULT NULL, nationality CLOB DEFAULT NULL, residence_authorization CLOB DEFAULT NULL, created_at DATETIME DEFAULT NULL, last_changed_at DATETIME DEFAULT NULL, given_name CLOB DEFAULT NULL, family_name CLOB DEFAULT NULL, street CLOB DEFAULT NULL, street_nr CLOB DEFAULT NULL, address_line CLOB DEFAULT NULL, postal_code INTEGER DEFAULT NULL, city CLOB DEFAULT NULL, country CLOB DEFAULT NULL, telephone CLOB DEFAULT NULL, telephone_mobile CLOB DEFAULT NULL, email CLOB NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO applicant (id, applicant_job_id, current_landlord_id, application_id, salutation, birth_date, civil_status, nationality, residence_authorization, created_at, last_changed_at, given_name, family_name, street, street_nr, address_line, postal_code, city, country, telephone, telephone_mobile, email) SELECT id, applicant_job_id, current_landlord_id, application_id, salutation, birth_date, civil_status, nationality, residence_authorization, created_at, last_changed_at, given_name, family_name, street, street_nr, address_line, postal_code, city, country, telephone, telephone_mobile, email FROM __temp__applicant');
        $this->addSql('DROP TABLE __temp__applicant');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_CAAD1019920427E9 ON applicant (applicant_job_id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_CAAD10196A5AD134 ON applicant (current_landlord_id)');
        $this->addSql('CREATE INDEX IDX_CAAD10193E030ACD ON applicant (application_id)');
        ...
        $this->addSql('DROP TABLE applicant_reference');
        $this->addSql('CREATE TABLE applicant_reference (id INTEGER NOT NULL, applicant_id INTEGER DEFAULT NULL, created_at DATETIME DEFAULT NULL, last_changed_at DATETIME DEFAULT NULL, name CLOB NOT NULL, description CLOB DEFAULT NULL, given_name CLOB DEFAULT NULL, family_name CLOB DEFAULT NULL, telephone CLOB DEFAULT NULL, telephone_mobile CLOB DEFAULT NULL, email CLOB NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('DROP INDEX IDX_A45BDDC1B25B14AF');
        $this->addSql('DROP INDEX IDX_A45BDDC17887A021');
        $this->addSql('CREATE TEMPORARY TABLE __temp__application AS SELECT id, application_slot_id, frontend_user_id, tenant_count_child, pets, instruments, status, created_at, last_changed_at FROM application');
        $this->addSql('DROP TABLE application');
        $this->addSql('CREATE TABLE application (id INTEGER NOT NULL, application_slot_id INTEGER DEFAULT NULL, frontend_user_id INTEGER DEFAULT NULL, tenant_count_child INTEGER DEFAULT NULL, pets CLOB DEFAULT NULL, instruments CLOB DEFAULT NULL, status INTEGER DEFAULT NULL, created_at DATETIME DEFAULT NULL, last_changed_at DATETIME DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO application (id, application_slot_id, frontend_user_id, tenant_count_child, pets, instruments, status, created_at, last_changed_at) SELECT id, application_slot_id, frontend_user_id, tenant_count_child, pets, instruments, status, created_at, last_changed_at FROM __temp__application');
        $this->addSql('DROP TABLE __temp__application');
        $this->addSql('CREATE INDEX IDX_A45BDDC1B25B14AF ON application (application_slot_id)');
        $this->addSql('CREATE INDEX IDX_A45BDDC17887A021 ON application (frontend_user_id)');
        $this->addSql('DROP INDEX IDX_E6BBFD9E3E030ACD');
