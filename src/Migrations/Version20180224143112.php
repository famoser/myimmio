 ...
 */
class Version20180224143112 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__application_preview AS SELECT id, application_slot_id, frontend_user_id FROM application_preview');
        ...
        $this->addSql('INSERT INTO application_preview (id, application_slot_id, frontend_user_id) SELECT id, application_slot_id, frontend_user_id FROM __temp__application_preview');
        ...
        $this->addSql('ALTER TABLE company ADD COLUMN created_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE company ADD COLUMN last_changed_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE email ADD COLUMN created_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE email ADD COLUMN last_changed_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE frontend_user ADD COLUMN created_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE frontend_user ADD COLUMN last_changed_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE setting ADD COLUMN created_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE setting ADD COLUMN last_changed_at DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE INDEX IDX_978A66E14D2A7E12 ON building_backend_user (building_id)');
        $this->addSql('CREATE INDEX IDX_978A66E19F66D4CC ON building_backend_user (backend_user_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__company AS SELECT id, name, description, street, street_nr, address_line, postal_code, city, country FROM company');
        ...
        $this->addSql('INSERT INTO company (id, name, description, street, street_nr, address_line, postal_code, city, country) SELECT id, name, description, street, street_nr, address_line, postal_code, city, country FROM __temp__company');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__frontend_user AS SELECT id, email, password_hash, reset_hash, is_enabled, registration_date, agb_accepted, street, street_nr, address_line, postal_code, city, country FROM frontend_user');
        ...
        $this->addSql('INSERT INTO frontend_user (id, email, password_hash, reset_hash, is_enabled, registration_date, agb_accepted, street, street_nr, address_line, postal_code, city, country) SELECT id, email, password_hash, reset_hash, is_enabled, registration_date, agb_accepted, street, street_nr, address_line, postal_code, city, country FROM __temp__frontend_user');
        ...
        $this->addSql('CREATE TABLE setting (id INTEGER NOT NULL, "key" CLOB NOT NULL, content CLOB NOT NULL, PRIMARY KEY(id))');
