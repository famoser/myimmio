 ...
 */
class Version20180224085751 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__application AS SELECT id, application_slot_id, pets, instruments FROM application');
        $this->addSql('DROP TABLE application');
        $this->addSql('CREATE TABLE application (id INTEGER NOT NULL, application_slot_id INTEGER DEFAULT NULL, frontend_user_id INTEGER DEFAULT NULL, pets CLOB DEFAULT NULL COLLATE BINARY, instruments CLOB DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_A45BDDC1B25B14AF FOREIGN KEY (application_slot_id) REFERENCES application_slot (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_A45BDDC17887A021 FOREIGN KEY (frontend_user_id) REFERENCES frontend_user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO application (id, application_slot_id, pets, instruments) SELECT id, application_slot_id, pets, instruments FROM __temp__application');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__application AS SELECT id, application_slot_id, pets, instruments FROM application');
        $this->addSql('DROP TABLE application');
        $this->addSql('CREATE TABLE application (id INTEGER NOT NULL, application_slot_id INTEGER DEFAULT NULL, pets CLOB DEFAULT NULL, instruments CLOB DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO application (id, application_slot_id, pets, instruments) SELECT id, application_slot_id, pets, instruments FROM __temp__application');
        $this->addSql('DROP TABLE __temp__application');
        $this->addSql('CREATE INDEX IDX_A45BDDC1B25B14AF ON application (application_slot_id)');
        $this->addSql('DROP INDEX IDX_5BE248EF176DFE85');
        $this->addSql('CREATE TEMPORARY TABLE __temp__application_slot AS SELECT id, apartment_id, start_at, end_at, identifier, welcome_header, welcome_text, display_tenant_count_adult, display_tenant_count_child, display_pet, display_play_instrument, display_garage, display_car_park, display_birth_date, display_civil_status, display_nationality, display_residence_authorization, display_payment_enforcement, display_leasing_contracts, display_leasing_rate_per_month, display_telephone, display_telephone_mobile, display_email, display_employer, display_old_landlord, display_relocation_reason, display_notice_by, display_salary, name, description FROM application_slot');
        $this->addSql('DROP TABLE application_slot');
        $this->addSql('CREATE TABLE application_slot (id INTEGER NOT NULL, apartment_id INTEGER DEFAULT NULL, start_at DATETIME DEFAULT NULL, end_at DATETIME DEFAULT NULL, identifier CLOB DEFAULT NULL, welcome_header CLOB DEFAULT NULL, welcome_text CLOB DEFAULT NULL, display_tenant_count_adult INTEGER NOT NULL, display_tenant_count_child INTEGER NOT NULL, display_pet INTEGER NOT NULL, display_play_instrument INTEGER NOT NULL, display_garage INTEGER NOT NULL, display_car_park INTEGER NOT NULL, display_birth_date INTEGER NOT NULL, display_civil_status INTEGER NOT NULL, display_nationality INTEGER NOT NULL, display_residence_authorization INTEGER NOT NULL, display_payment_enforcement INTEGER NOT NULL, display_leasing_contracts INTEGER NOT NULL, display_leasing_rate_per_month INTEGER NOT NULL, display_telephone INTEGER NOT NULL, display_telephone_mobile INTEGER NOT NULL, display_email INTEGER NOT NULL, display_employer INTEGER NOT NULL, display_old_landlord INTEGER NOT NULL, display_relocation_reason INTEGER NOT NULL, display_notice_by INTEGER NOT NULL, display_salary INTEGER NOT NULL, name CLOB NOT NULL, description CLOB DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO application_slot (id, apartment_id, start_at, end_at, identifier, welcome_header, welcome_text, display_tenant_count_adult, display_tenant_count_child, display_pet, display_play_instrument, display_garage, display_car_park, display_birth_date, display_civil_status, display_nationality, display_residence_authorization, display_payment_enforcement, display_leasing_contracts, display_leasing_rate_per_month, display_telephone, display_telephone_mobile, display_email, display_employer, display_old_landlord, display_relocation_reason, display_notice_by, display_salary, name, description) SELECT id, apartment_id, start_at, end_at, identifier, welcome_header, welcome_text, display_tenant_count_adult, display_tenant_count_child, display_pet, display_play_instrument, display_garage, display_car_park, display_birth_date, display_civil_status, display_nationality, display_residence_authorization, display_payment_enforcement, display_leasing_contracts, display_leasing_rate_per_month, display_telephone, display_telephone_mobile, display_email, display_employer, display_old_landlord, display_relocation_reason, display_notice_by, display_salary, name, description FROM __temp__application_slot');
        $this->addSql('DROP TABLE __temp__application_slot');
        $this->addSql('CREATE INDEX IDX_5BE248EF176DFE85 ON application_slot (apartment_id)');
        $this->addSql('DROP INDEX UNIQ_C73586EE7927C74');
        $this->addSql('DROP INDEX IDX_C73586E979B1AD6');
