 ...
 */
class Version20180224184356 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE application_application_label (application_id INTEGER NOT NULL, application_label_id INTEGER NOT NULL, PRIMARY KEY(application_id, application_label_id))');
        $this->addSql('CREATE INDEX IDX_E6BBFD9E3E030ACD ON application_application_label (application_id)');
        $this->addSql('CREATE INDEX IDX_E6BBFD9E8C82F02A ON application_application_label (application_label_id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE application_application_label');
        $this->addSql('DROP INDEX IDX_4D7E68544D2A7E12');
        ...
        $this->addSql('DROP TABLE applicant_reference');
        $this->addSql('CREATE TABLE applicant_reference (id INTEGER NOT NULL, applicant_id INTEGER DEFAULT NULL, created_at DATETIME DEFAULT NULL, last_changed_at DATETIME DEFAULT NULL, name CLOB NOT NULL, description CLOB DEFAULT NULL, given_name CLOB NOT NULL, family_name CLOB NOT NULL, telephone CLOB DEFAULT NULL, telephone_mobile CLOB DEFAULT NULL, email CLOB NOT NULL, PRIMARY KEY(id))');
