 ...
 */
class Version20180225010300 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__applicant AS SELECT id, applicant_job_id, application_id, salutation, birth_date, civil_status, nationality, street, street_nr, address_line, postal_code, city, country, telephone, email, residence_authorization, telephone_mobile, created_at, last_changed_at, given_name, family_name FROM applicant');
        ...
        $this->addSql('INSERT INTO applicant (id, applicant_job_id, application_id, salutation, birth_date, civil_status, nationality, street, street_nr, address_line, postal_code, city, country, telephone, email, residence_authorization, telephone_mobile, created_at, last_changed_at, given_name, family_name) SELECT id, applicant_job_id, application_id, salutation, birth_date, civil_status, nationality, street, street_nr, address_line, postal_code, city, country, telephone, email, residence_authorization, telephone_mobile, created_at, last_changed_at, given_name, family_name FROM __temp__applicant');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX IDX_CAAD10193E030ACD');
        $this->addSql('CREATE TEMPORARY TABLE __temp__applicant AS SELECT id, applicant_job_id, application_id, salutation, birth_date, civil_status, nationality, residence_authorization, created_at, last_changed_at, given_name, family_name, street, street_nr, address_line, postal_code, city, country, telephone, telephone_mobile, email FROM applicant');
        $this->addSql('DROP TABLE applicant');
        $this->addSql('CREATE TABLE applicant (id INTEGER NOT NULL, applicant_job_id INTEGER DEFAULT NULL, application_id INTEGER DEFAULT NULL, salutation CLOB DEFAULT NULL, birth_date DATE DEFAULT NULL, civil_status CLOB DEFAULT NULL, nationality CLOB DEFAULT NULL, residence_authorization CLOB DEFAULT NULL, created_at DATETIME DEFAULT NULL, last_changed_at DATETIME DEFAULT NULL, given_name CLOB DEFAULT NULL, family_name CLOB DEFAULT NULL, street CLOB DEFAULT NULL, street_nr CLOB DEFAULT NULL, address_line CLOB DEFAULT NULL, postal_code INTEGER DEFAULT NULL, city CLOB DEFAULT NULL, country CLOB DEFAULT NULL, telephone CLOB DEFAULT NULL, telephone_mobile CLOB DEFAULT NULL, email CLOB NOT NULL, current_landlord CLOB DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO applicant (id, applicant_job_id, application_id, salutation, birth_date, civil_status, nationality, residence_authorization, created_at, last_changed_at, given_name, family_name, street, street_nr, address_line, postal_code, city, country, telephone, telephone_mobile, email) SELECT id, applicant_job_id, application_id, salutation, birth_date, civil_status, nationality, residence_authorization, created_at, last_changed_at, given_name, family_name, street, street_nr, address_line, postal_code, city, country, telephone, telephone_mobile, email FROM __temp__applicant');
        $this->addSql('DROP TABLE __temp__applicant');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_CAAD1019920427E9 ON applicant (applicant_job_id)');
        $this->addSql('CREATE INDEX IDX_CAAD10193E030ACD ON applicant (application_id)');
        $this->addSql('DROP INDEX UNIQ_E79CAB6D1645DEA9');
