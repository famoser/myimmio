 ...
 */
class Version20180225001222 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__applicant AS SELECT id, applicant_job_id, application_id, salutation, birth_date, civil_status, nationality, current_landlord, street, street_nr, address_line, postal_code, city, country, telephone, email, residence_authorization, telephone_mobile, created_at, last_changed_at, given_name, family_name FROM applicant');
        ...
        $this->addSql('INSERT INTO applicant (id, applicant_job_id, application_id, salutation, birth_date, civil_status, nationality, current_landlord, street, street_nr, address_line, postal_code, city, country, telephone, email, residence_authorization, telephone_mobile, created_at, last_changed_at, given_name, family_name) SELECT id, applicant_job_id, application_id, salutation, birth_date, civil_status, nationality, current_landlord, street, street_nr, address_line, postal_code, city, country, telephone, email, residence_authorization, telephone_mobile, created_at, last_changed_at, given_name, family_name FROM __temp__applicant');
