 ...
 */
class Version20180224180728 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE application_label (id INTEGER NOT NULL, name CLOB NOT NULL, color CLOB NOT NULL, created_at DATETIME DEFAULT NULL, last_changed_at DATETIME DEFAULT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE application_label');
        $this->addSql('DROP INDEX IDX_4D7E68544D2A7E12');
